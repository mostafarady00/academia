...
@endif
<form action="{{ route('instructors.update',$instructor->id) }}" method="POST" enctype="multipart/form-data" class="form-group">
    @csrf
    @method("PUT")
...
@enderror
<input type="text" name="instruct_subject" value="{{ $instructor->instruct_subject }}" placeholder="Enter New instruct_subject" class="form-input">
